        ...
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-4">
                ...
                <div class="text-center w-100 my-3">
                    <button type="submit" class="btn btn-primary mx-1 share"> @lang('kotaby.sharebook')</button>
                    <button type="button" class="btn btn-secondary mx-1 share"> @lang('kotaby.cancel')</button>
                </div>
            </div>
        </form>
    </div>
