...
<head>
    ...
    <title>Gadwall App Dev - App Landing Page</title>
...
-->
    ...
    <link rel="stylesheet" href="{{ asset('css/home/templatemo-chain-app-dev.css') }}">
    <link rel="stylesheet" href="{{ asset('css/home/animated.css') }}">
    <link rel="stylesheet" href="{{ asset('css/home/owl.css') }}">
...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="{{ asset('images/img/logo.svg') }}" alt="Chain App Dev">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            ...
                            <li>
                                <div class="gradient-button"><a href="{{ route('loginindex') }}"><i
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <img src="{{ asset('images/home/heading-line-dec.png') }}" alt="">
                        <p>If you need the greatest collection of HTML templates for your business, please visit <a
                            ...
                            need to have a contact form PHP
                            script, go to <a href="https://templatemo.com/contact" target="_parent">our contact
                                page</a> for more
                            information.</p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="right-image">
                        <img src="{{ asset('images/home/about-right-dec.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="client-content">
                                                                ...
                                                                <p>“CTO, Lorem ipsum dolor sit amet, consectetur
                                                                    ...
                                                                    idunte ut labore et dolore magna aliqua darwin
                                                                    kengan
                                                                    lorem ipsum dolor sit amet, consectetur picing elit
                                                                    massive big blasta.”</p>
                                                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="pricing-item-regular">
                        ...
                        <div class="icon">
                            <img src="{{ asset('images/home/pricing-table-01.png') }}" alt="">
                        </div>
                        <ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="footer-widget">
                        ...
                        <div class="logo">
                            <img src="{{ asset('images/home/white-logo.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="copyright-text">
                        <p>Copyright © 2022 Shalaby App Dev Company. All Rights Reserved.
                            <br>Design: <a href="#" target="_blank" title="css templates">TemplateMo</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('js/home/imagesloaded.js') }}"></script>
